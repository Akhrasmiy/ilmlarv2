...
const {
  ...
  getCourseDetailswithouttoken,
  getlessondetails,
  getCourseDetailsForTeacher,
  getlessonForTeacherdetails,
  aaddCourseVideos,
  uploadCourseImage
...
const {
  getsignedurlforfront,
} = require("../../shared/uploads/uploadTrailerService");

const router = express.Router();
router.post("/courses/:idx/image", uploadCourseImage);
